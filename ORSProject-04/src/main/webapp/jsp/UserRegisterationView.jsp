<%@page import="in.co.rays.proj4.controller.UserRegisterationCtl"%>
...
<body>
	<form action="<%=ORSView.USER_REGISTERATION_CTL%>" method="post">
			...
			<table>
				...
				<tr>
					...
					<td align="left" colspan="2"><input type="submit"
						name="operation" value="<%=UserRegisterationCtl.OP_SIGN_UP%>">&nbsp;
						<input type="submit" name="operation"
						value="<%=UserRegisterationCtl.OP_RESET%>"></td>
				</tr>
			</table>
		</div>
	</form>
