...
public class DataUtility {
	...
	public static Timestamp getTimestamp(String val) {
		Timestamp timestap = null;
		try {
			timestap = new Timestamp(timeFormatter.parse(val).getTime());
		}
		catch(Exception e) {
			return null;
		}
	...
	public static void main(String[] args) {
		...
		// Test getStringData
				...
				String timestampStr = "10/05/2024 10:30:45";
