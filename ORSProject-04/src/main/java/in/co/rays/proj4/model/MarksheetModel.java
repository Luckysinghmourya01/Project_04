...
public class MarksheetModel {
	...
	public long add(MarksheetBean bean) throws ApplicationException, DublicateRecordException {
		...
		MarksheetBean duplicatemark = findByRollNo(bean.getRollNo());
		if (duplicatemark != null) {
			throw new DublicateRecordException("exception : roll no already exist");
		}
	...
	public void update(MarksheetBean bean) throws ApplicationException, DublicateRecordException {
		...
		if (beanExist != null && beanExist.getId() != bean.getId()) {
			throw new DublicateRecordException("Roll No is already exist");
		}
	...
	pstm.close();
		  ...
		  throw new ApplicationException("exception is getting meri list of marksheet");
	  }
	  finally {
		  JDBCDataSource.closeconnection(conn);
	  }
