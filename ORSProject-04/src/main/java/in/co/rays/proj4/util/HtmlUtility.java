...
public class HtmlUtility {
	...
	public static void testGetListByMap() {
		...
		String htmlSelectFormMap = HtmlUtility.getList("gender", selectedValue, map);

		System.out.println(htmlSelectFormMap);
	}
	...
	public static void testGetListByList() throws Exception {
		...
		String htmlSelectFromList = HtmlUtility.getList("model", selectedValue, list);
