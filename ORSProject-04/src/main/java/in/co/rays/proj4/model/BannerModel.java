...
public class BannerModel {
    ...
    public void delete(bannerBean bean) throws ApplicationException {
        ...
        try {
            ...
            PreparedStatement pstmt = conn.prepareStatement(
                "delete from st_banner where id=?");
    ...
    public bannerBean findByPk(long pk) throws ApplicationException {
        ...
        try {
            conn = JDBCDataSource.getConnection();
            PreparedStatement pstmt = conn.prepareStatement(
                "select * from st_banner where id=?");
    ...
    public bannerBean findByBannerCode(String bannerCode)
            throws ApplicationException {
        ...
        try {
            ...
            PreparedStatement pstmt = conn.prepareStatement(
                    "select * from st_banner where banner_code = ?");
