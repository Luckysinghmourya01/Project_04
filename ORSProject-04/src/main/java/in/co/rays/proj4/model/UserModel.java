...
public class UserModel {
	...
	public void delete(UserBean bean) throws ApplicationException {
		...
		try {
			...
			try {
				...
				throw new ApplicationException("exception : exception is getting delete rollback" + ex.getMessage());
			}
			throw new ApplicationException("exception is getting delete st_user");
		} finally {
			JDBCDataSource.closeconnection(conn);
		}
	}
	...
	public void update(UserBean bean) throws DublicateRecordException, ApplicationException {
		...
		if (beanExist != null && !(beanExist.getId() == bean.getId())) {
			throw new DublicateRecordException("Login Id is already exist");
		}
